 ...
 */
class Version20170816194118 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE wallpaper ADD file VARCHAR(255) NOT NULL, CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE wallpaper DROP file, CHANGE category_id category_id VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
